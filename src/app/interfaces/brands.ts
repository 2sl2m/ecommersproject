// To parse this data:
//
//   import { Convert, Brands } from "./file";
//
//   const brands = Convert.toBrands(json);
//
...
export class Convert {
    public static toBrands(json: string): Brands {
        return cast(JSON.parse(json), r("Brands"));
    }

    public static brandsToJson(value: Brands): string {
        return JSON.stringify(uncast(value, r("Brands")), null, 2);
    }
}
